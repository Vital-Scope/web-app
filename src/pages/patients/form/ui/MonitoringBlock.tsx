...
const MonitoringBlock: React.FC<Props> = ({ data }) => (
  <div className="w-full max-w-5xl bg-white rounded-2xl border-2 border-[#E5E7EB] p-6 shadow transition-colors duration-200 hover:border-[#8B5CF6] focus-within:border-[#8B5CF6]">
